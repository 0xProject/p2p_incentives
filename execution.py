...
class Execution:
    ...
    def run(self):
        ...
        if spreading_ratio_lists:
            ...
            average_order_spreading_ratio = data_processing.averageLists(spreading_ratio_lists)
        ...
        if normal_peer_satisfaction_lists:
            ...
            normal_satistaction_density = data_processing.\
        ...
        if free_rider_satisfaction_lists:
            ...
            freerider_satistaction_density = data_processing.\
